        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="index.html" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{asset('assets/images/koshiIcon.png')}}" alt="" height="70">
                    </span>
                    <span class="logo-lg">
                        <img src=" {{asset('assets/images/koshi.png')}}" alt="" style="width:100%;height:100px">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user" src="{{asset($data)}}" alt="Header Avatar">
                    @else
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    @php
                    $bid=Crypt::encrypt(Auth::user()->id ?? '');
                    @endphp
                    <a class="dropdown-item" href="{{route('admin.profile',$bid)}}"><i
                    ...
                    <a class="dropdown-item" href="{{route('admin.password',$bid)}}"><i
